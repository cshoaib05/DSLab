...
int peek(int a)
{
return(stack[a])//return element at the top of stack
}
...
int main(){
	int choice,e;
	do
	{	printf("MENu:\npress.1 PEEK\npress.2 PUSH\npress.3 POP\npress.4 EXIT");  	//display menu 1.peek 2.push 3.pop 4.exit
		printf("enter your choice");
		scanf("%d",&choice);														//take input in choice variable
		switch(choice)
		{
			case 1:
				peak();																//call peek function
				break;
			case 2:
			...
			case 3:
				...
				break;
			case 4:
			return 0;																	//call exit(0) function or return 0
				break;
			default:
				printf("invalid choices");													//invalid choice				
		}
	}while(1);
	return 0;
}
